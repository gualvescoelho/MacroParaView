...
# find source
nome_arquivo = FindSource( 'nome_arquivo.' )

# set active source
SetActiveSource( nome_arquivo )
...
plotOverLine1.Point1 = [ posicao_x1 , posicao_y1 , posicao_z1 ]
plotOverLine1.Point2 = [ posicao_x2 , posicao_y2 , posicao_z2 ]
